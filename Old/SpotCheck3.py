    ...
    if filename:
        ...
        for encoding in encodings:
            try:
                ...
                return pd.read_csv(filename, encoding=encoding, low_memory=False), filename  # Added low_memory=False
...
def main():
    ...
    if df is not None and input_filename is not None:
        try:
            ...
            save_filtered_groups_to_csv(input_filename, df, group_assignments, sub_group_assignments, min_size, export_columns, allowed_institutions)
